...
export const EXPERIENCE: Experience[] = [
  {
    ...
    startDate: "Aug 2025",
    endDate: "Feb 2026",
    title: "Senior Manager – iGV (Incoming Global Volunteer)",
    company: "AIESEC",
    description: [
      "Led international volunteer operations and partnerships for social impact projects.",
      "Mentored team members and ensured seamless onboarding for global participants.",
    ],
    skills: [],
  },
  {
    ...
    company: "AIESEC",
    description: [
      "Directed a BD team to secure strategic partnerships and revenue growth.",
    ],
    skills: [],
  },
  {
    ...
    company: "Open Source",
    description: [
      "Contributing across web, ML, DevOps & sustainability projects.",
    ],
    skills: [],
  },
  {
    ...
    startDate: "",
    endDate: "Present",
    title: "Spokesperson & Tech Team",
    company: "IEEE Student Member",
    description: [
      "Representing IEEE as spokesperson and contributing to the tech team.",
    ],
    skills: [],
  },
  {
